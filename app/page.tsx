// pocetna stranica na kojoj su prikazne najbolje ocijenjene serije
"use client";
...
export default function HomePage() {
  ...
  const handleLoadMore = () => { // za ucitavanje dodatnih 15
...
{/* prikazuje se samo ako ima jos serija za prikaz */}
